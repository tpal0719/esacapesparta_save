...
import static com.sparta.domain.s3.S3Util.createStoreImageDir;
import static com.sparta.domain.s3.S3Util.createThemeImageDir;
import static com.sparta.domain.s3.S3Util.doesFileExist;
import static com.sparta.domain.s3.S3Util.getValidateImageExtension;
  ...
  private String uploadFileToS3(MultipartFile file, String uploadFileName) {
    ...
    try (InputStream inputStream = file.getInputStream()) {
      amazonS3Client.putObject(
          new PutObjectRequest(bucket, uploadFileName, inputStream, objectMetadata).withCannedAcl(
